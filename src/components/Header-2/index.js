  ...
  return (
    <header className="headers-wrapper h-20 w-full flex justify-between items-center container-fluid px-4 md:px-14 2xl:px-0 2xl:container mx-auto">
      <img
        ...
        className={`w-30 h-8 ${isScrolled ? "pl-20" : "pl-0"}`}
        alt="logo"
      />
      <ul className="flex pr-10">
        <li className="mr-8 nav-list">
          <a
            className={`${
              isScrolled
                ? "text-white hover:text-[#e81d78]"
                : "text-black hover:text-[#e81d78]"
            } font-medium cursor-pointer text-[14px] uppercase hover:underline decoration-4 underline-offset-4`}
            href="/learn"
          >
            Learn
          </a>
